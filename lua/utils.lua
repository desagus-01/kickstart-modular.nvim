...
local function make_float(opts)
  ...
  -- Optional title (Neovim supports title/title_pos on floats)
  if title then
...
function M.float_term(cmd, opts)
  ...
  -- cmd can be a string or a list like { "sh", "-c", "..." }
  local term_cmd
  ...
  local function close()
    ...
    -- buf wipes because bufhidden=wipe
  end
  ...
  -- Keymaps to close (terminal + normal)
